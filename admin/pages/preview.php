<div class="wrap" id="coding-blocks">
    <div class="container py-4 px-4">
        ...
        <div class="mt-4">
            <!--config-->
            <div class="field">
                <label class="checkbox"><input type="checkbox" id="inp_linenums">Enable Line Numbers</label>
            </div>
            <div class="field">
                <label class="checkbox"><input type="checkbox" id="inp_copybtn">Enable Copy Button</label>
            </div>
        </div>
    ...
    margin-top: 20px;">
                    ...
                    <button class="button is-warning" onclick="cbBuildPreview()" type="button">PREVIEW</button>
                </div>
            </div>
